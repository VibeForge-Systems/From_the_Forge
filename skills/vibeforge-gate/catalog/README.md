...
| File | Contents |
|---|---|
| `universal.yaml` | Works in any repo: sign-off (DCO), commit subjects, conflict markers, oversized files, trailing whitespace, shell syntax, shellcheck, and a check that the manifest itself still parses |
| `languages.yaml` | Go, Node/TypeScript, Python, Rust, containers |
| `supply-chain.yaml` | Secret scanning, SAST, dependency vulnerabilities, license policy, SBOM — the tier most often sold as a paid add-on |
